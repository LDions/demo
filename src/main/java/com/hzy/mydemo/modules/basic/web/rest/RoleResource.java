...
/**
 * REST controller for managing {@link com.hzy.mydemo.modules.basic.domain.Role}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingRole -> {
                    ...
                    if (role.getUpdatedTime() != null) {
                        existingRole.setUpdatedTime(role.getUpdatedTime());
                    }
                    ...
                    if (role.getInlay() != null) {
                        existingRole.setInlay(role.getInlay());
                    }
