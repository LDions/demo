            ...
            .map(
                existingUsers -> {
                    ...
                    if (users.getCreatedTime() != null) {
                        existingUsers.setCreatedTime(users.getCreatedTime());
                    }
                    if (users.getUpdatedBy() != null) {
                        existingUsers.setUpdatedBy(users.getUpdatedBy());
                    }
                    if (users.getUpdatedTime() != null) {
                        existingUsers.setUpdatedTime(users.getUpdatedTime());
                    }
                    if (users.getDeleted() != null) {
                        existingUsers.setDeleted(users.getDeleted());
                    }
                    ...
                    if (users.getResetCode() != null) {
                        existingUsers.setResetCode(users.getResetCode());
                    }
                    if (users.getResetTime() != null) {
                        existingUsers.setResetTime(users.getResetTime());
                    }
                    if (users.getUserCode() != null) {
                        existingUsers.setUserCode(users.getUserCode());
                    }
                    if (users.getPhone() != null) {
                        existingUsers.setPhone(users.getPhone());
                    }
                    if (users.getActivate() != null) {
                        existingUsers.setActivate(users.getActivate());
                    }
